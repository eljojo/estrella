...
fn generate_golden_files() {
    ...
    write_golden("framed_receipt", "bin", &receipt::framed_receipt());
    ...
    let framed_program = receipt::program_by_name("receipt-frame").unwrap();
    write_golden("framed_receipt", "png", &generate_preview_png(&framed_program));
...
#[test]
fn test_binary_framed_receipt() {
    let cmd = receipt::framed_receipt();
    check_golden("framed_receipt", "bin", &cmd);
}
...
#[test]
fn test_preview_framed_receipt() {
    let program = receipt::program_by_name("receipt-frame").unwrap();
    let png = generate_preview_png(&program);
    check_golden("framed_receipt", "png", &png);
}
